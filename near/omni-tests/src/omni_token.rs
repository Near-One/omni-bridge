...
mod tests {
    ...
    use crate::helpers::tests::{
        ...
        eth_factory_address, eth_token_address, get_test_deploy_token_args, hype_factory_address,
        locker_wasm, mock_global_contract_deployer_wasm, mock_prover_wasm, omni_token_wasm,
        pol_factory_address, sol_factory_address, sol_token_address, token_deployer_wasm,
    ...
    impl DeployEnv {
        ...
        async fn new(
            ...
            let factory_contract_address = match init_token_address.get_chain() {
                ...
                ChainKind::Hype => hype_factory_address(),
