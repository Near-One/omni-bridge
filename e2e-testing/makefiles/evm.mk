...
$$($(1)_enear_address_file): $$($(1)_enear_creation_file) $(common_tools_compile_stamp) | $$($(1)_deploy_results_dir)
...
$$($(1)_test_token_address_file): $(common_tools_compile_stamp) | $$($(1)_deploy_results_dir)
