...
- **Relayer stakes are paid to the rejecting manager**: `rejectRelayerApplication` sends the stake to the caller (a `RELAYER_MANAGER_ROLE` holder or the admin) as a punishment, matching the NEAR side
