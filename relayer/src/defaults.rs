...
pub const TOKEN_LOCKER_ID_TESTNET: &str = "omni-locker.test1-dev.testnet";
pub const BRIDGE_TOKEN_FACTORY_ADDRESS_TESTNET: &str = "0xCF6462b9fcE5aF3E6c660c83453ECa18Ff468773";
